...
/**
 * Implements a Link State Algorithm using Dijkstra's least-cost path graph searching.
 * Additionally, produces a forwarding table that is based on the given input.
...
//		scanner.close();
	...
	private static void setShortestPaths(RouterNode source, RouterNode[] nodes) {
		...
		// The source would obviously have the smallest cost being set to 0 on itself
		source.smallestCost = 0;
		
		// Implementation: http://en.wikipedia.org/wiki/Dijkstra%27s_algorithm#Using_a_priority_queue		
